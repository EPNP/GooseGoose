          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ...
                  : ProfileWidget(
                      userProfile:
                          params.getParam('userProfile', ParamType.Document),
                      userTweet: params.getParam(
                          'userTweet',
                          ParamType.DocumentReference,
                          false,
                          ['users', 'tweets']),
            ...
            FFRoute(
              name: 'SelectChat',
              path: 'selectChat',
              builder: (context, params) => SelectChatWidget(),
            ),
            FFRoute(
              name: 'PostTweet',
              path: 'postTweet',
              builder: (context, params) => PostTweetWidget(),
            ),
            FFRoute(
              name: 'SearchPage',
              path: 'searchPage',
